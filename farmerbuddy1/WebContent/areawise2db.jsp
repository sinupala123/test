...
out.println("<font color='green' size='5'>"+cropname+"</font>");
...
String sql="select * from crops where cropname=?";
...
%>
	<tr>
	<td><center><font size="4" color="red"><%=rs.getString("state") %></td>
	<td><center><font size="4" color="red"><%=rs.getString("soilname") %></td>
	<td><center><font size="4" color="red"><%=rs.getString("type") %></td>
	<td><center><font size="4" color="red"><%=rs.getString("cropname") %></td>
