...
<%@page import="java.sql.Connection"%>
	...
	out.println("<center><font size='5' color='green'>FOR THE Date OF::: "+arrivald+"</font><br>");
...
%>	
            <center>
    <br>
     <table width="800" border="1" align="center" bordercolor="#CD848F" bgcolor="FFFFFF">
<tr>
...
<td><font size="4" color="red">Arrival Date</td>
...
String sql="select * from marketreport where commedity=? and arrivald=?";
...
%>
	...
	<td><font size="4" color="red"><%=rs.getString("arrivald") %></td>
...
<% 
RequestDispatcher rd=request.getRequestDispatcher("/fmktdaily.jsp");  
